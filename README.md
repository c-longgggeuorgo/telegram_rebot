...
6. 创建D1数据库，创建一个D1数据库`telegram-bot-db`，点击`Explore Data`，复制[D1数据库]((https://raw.githubusercontent.com/c-longgggeuorgo/telegram_rebot/refs/heads/main/data/D1%E6%95%B0%E6%8D%AE%E5%BA%93.md),点击`Run all statement`
